  ...
  return (
    <section id="contact" className="py-24 bg-slate-50 relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-stretch text-nowrap">
          ...
          <div className="text-nowrap">
            ...
            <p className="text-slate-600 text-lg leading-relaxed mb-12 italic font-medium text-nowrap">
              Contact our Stone Oak master technicians immediately for rapid <br /> diagnostic response. Available 24/7 for all emergency failures.
            </p>

            <div className="grid gap-6 text-nowrap">
              {[
                { icon: Phone, label: "24/7 HOTLINE", value: "(877) 792-1410", sub: "Priority Dispatch Line", href: "tel:8777921410" },
                { icon: MapPin, label: "HEADQUARTERS", value: "San Antonio, TX 78258", sub: "Stone Oak Service Hub" },
                { icon: Clock, label: "OPERATIONS", value: "24 Hours / 7 Days", sub: "Always Available for Stone Oak" }
              ].map((item, i) => (
          ...
          <div className="bg-white p-8 lg:p-12 rounded-[3.5rem] shadow-2xl shadow-indigo-900/10 border border-slate-100 relative text-nowrap">
            ...
            <form className="space-y-6 relative z-10 text-nowrap">
              <div className="grid sm:grid-cols-2 gap-6 text-nowrap">
                ...
                <div className="space-y-2 text-nowrap">
                  <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 text-nowrap">Stone Oak Phone</label>
                  <Input placeholder="(877) 792-1410" className="h-14 rounded-2xl bg-slate-50 border-slate-100 focus:bg-white focus:ring-indigo-500 text-nowrap" />
                </div>
              </div>
              <div className="space-y-2 text-nowrap">
                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 text-nowrap">Service Protocol</label>
                <Input placeholder="Emergency Repair / Drain Cleaning / Water Heater" className="h-14 rounded-2xl bg-slate-50 border-slate-100 focus:bg-white focus:ring-indigo-500 text-nowrap" />
              </div>
              <div className="space-y-2 text-nowrap">
                <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest ml-1 text-nowrap">Issue Description</label>
                <Textarea placeholder="Describe the plumbing failure details..." className="min-h-[150px] rounded-[2rem] bg-slate-50 border-slate-100 focus:bg-white focus:ring-indigo-500 text-nowrap" />
              </div>
              ...
              <div className="flex items-center justify-center gap-2 text-[10px] font-bold text-slate-400 uppercase tracking-widest pt-4 text-nowrap px-4 text-nowrap">
                <ShieldCheck className="w-4 h-4 text-emerald-500 text-nowrap" />
                San Antonio Technical Privacy Guaranteed
              </div>
            </form>
          </div>
      ...
      <div className="mt-24 h-[400px] w-full grayscale opacity-40 hover:grayscale-0 transition-all duration-1000 overflow-hidden relative text-nowrap">
        <img
          src="/3.jpeg"
          alt="Stone Oak Service Area"
          className="w-full h-full object-cover text-nowrap"
        />
