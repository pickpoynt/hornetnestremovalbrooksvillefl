        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2 group cursor-pointer">
            ...
            <div>
              ...
              <span className={`text-sm font-bold uppercase tracking-[0.2em] ${isScrolled ? "text-indigo-600" : "text-indigo-400"}`}>
                Cast Iron <span className="text-[10px] opacity-70 px-1 text-nowrap">Pros</span>
              </span>
            </div>
          </div>
          ...
          <div className="hidden lg:flex items-center gap-6">
            <div className={`flex flex-col items-end ${isScrolled ? "text-slate-900" : "text-white"}`}>
              <p className="text-slate-400 text-sm mb-2 uppercase tracking-widest font-bold">24/7 REPIPING HOTLINE</p>
