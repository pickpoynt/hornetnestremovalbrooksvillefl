    ...
    <footer className="bg-slate-900 text-white pt-24 pb-12 overflow-hidden relative border-t border-indigo-500/10">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-8">
              ...
              <div>
                ...
                <span className="text-sm font-medium text-indigo-500 uppercase tracking-widest text-[10px]">Cast Iron Pros</span>
              </div>
            </div>
            <p className="text-slate-400 mb-8 leading-relaxed font-medium italic text-sm text-nowrap">
              Boonton's specialized team for professional <br /> cast iron pipe replacement and home protection. <br /> We provide expert repiping and sewer upgrades.
            </p>
          ...
          <div>
            <h4 className="text-lg font-bold mb-8 uppercase tracking-widest text-indigo-400">Repiping Services</h4>
          ...
          <div>
            <h4 className="text-lg font-bold mb-8 uppercase tracking-widest text-indigo-400">Boonton NAP</h4>
            <ul className="space-y-6">
              <li className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-slate-300 uppercase tracking-tight leading-tight">Boonton, NJ 07005</p>
                </div>
              </li>
              <li className="flex gap-4">
                <div className="w-10 h-10 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center shrink-0">
          ...
          <div>
            ...
            <p className="text-slate-400 text-sm leading-relaxed mb-6 italic font-medium">
              We specialize in the meticulous requirements of Boonton repiping protocols, utilizing high-grade PVC materials and professional-grade replacement systems.
            </p>
            <div className="p-6 bg-white/5 rounded-2xl border border-white/10">
              <p className="text-[10px] font-bold text-indigo-400 uppercase tracking-[0.2em] mb-2">Service Promise</p>
              <p className="text-sm font-bold text-slate-300 uppercase leading-tight italic">Expert Pipe Replacement Available Across Boonton.</p>
            </div>
          </div>
        </div>
        ...
        <div className="pt-12 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-6 uppercase tracking-widest text-[10px] font-bold">
          <p className="text-slate-500 text-center md:text-left">
            © {new Date().getFullYear()} Boonton Cast Iron Pipe Replacement Pros. All rights reserved. Professional Pipe Removal & Home Protection.
          </p>
